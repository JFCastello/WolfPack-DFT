...
def print_dryrun_summary(summary: DryRunSummary) -> None:
    ...
    if m.has_data():
        ...
        print("     (TIER 3). Measured against 23 real VASP memory tables, these")
    ...
    *,
    ...
    if low:
        ...
        if m.model == "fallback-formulas":
            ...
            print("     comes from formulas. Checked against 23 real VASP memory")
            print("     tables, those formulas UNDER-estimate in 19 cases,")
