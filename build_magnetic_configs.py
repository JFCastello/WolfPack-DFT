...
grouped by type:
  ...
  magnetic_configs/
    ...
    run_pipelines.sh    <- launches the whole sweep in one go
...
* ONE COMMAND LAUNCHES THE WHOLE SWEEP. run_pipelines.sh
  submits dry-run -> recommend -> test in every folder at once,
